...
export default function LoginScreen() {
    ...
    function handleLogin() {
        Alert.alert("Login unavailable", "Authentication will be connected later.");
    }
    ...
    return (
        <Screen>
            ...
            <View style={styles.hero}>
                <View style={styles.heroText}>
                    ...
                    <Text style={styles.subtitle}>
                        Log in to continue your pet journey and view your matches
                    </Text>
                </View>
            ...
            <Card>
                ...
                <AppButton title="Log in" width={300} />
